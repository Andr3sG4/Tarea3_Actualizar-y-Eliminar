    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        <li class="nav-small-cap">
          ...
          <span class="hide-menu">Pantalla de Inicio </span>
        </li>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="Automoviles/automoviles.php" target="base" aria-expanded="false">
            <span>
              <i class="ti ti-car"></i>
            </span>
            <span class="hide-menu">Automoviles</span>
          </a>
        </li>
        <li class="sidebar-item">
